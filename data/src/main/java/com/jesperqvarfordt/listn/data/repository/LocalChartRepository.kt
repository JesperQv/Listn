...
class LocalChartRepository : ChartRepository {
    ...
    override fun getCharts(): Observable<List<Chart>> {
        val edm = Chart("Dance & EDM",
                ...
                "android.resource://com.jesperqvarfordt.musicplayer/drawable/rsz_edm")
        val hipHop = Chart("Hip-Hop & Rap",
                ...
                "android.resource://com.jesperqvarfordt.musicplayer/drawable/rsz_hiphop")
        ...
        val drumBass = Chart("Drum & Bass",
                ...
                "android.resource://com.jesperqvarfordt.musicplayer/drawable/rsz_drumbass")
        val pop = Chart("Pop",
                "https://api-v2.soundcloud.com/charts?kind=top&genre=soundcloud%3Agenres%3Apop&offset=0&limit=20",
                "android.resource://com.jesperqvarfordt.musicplayer/drawable/rsz_pop")
        val rbSoul = Chart("R&B & Soul",
                ...
                "android.resource://com.jesperqvarfordt.musicplayer/drawable/rsz_rbsoul")
